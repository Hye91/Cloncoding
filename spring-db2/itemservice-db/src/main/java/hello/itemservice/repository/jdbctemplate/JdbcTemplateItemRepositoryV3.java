...
//                .usingColumns("item_name","price","quantity"); 생략 가능한 부분
        //          SimpleJdbcInsert가 dataSource와 item 테이블을 가지고 메타데이터로 읽어들이기 때문에 생략가능하게된다
    }
    ...
    public Item save(Item item) {
        ...
        //새로운 레코드를 데이터베이스에 삽입하고, 그 결과로 생성된 키 값을 얻어옴, excute : sava,insert의 과정을 동반함
